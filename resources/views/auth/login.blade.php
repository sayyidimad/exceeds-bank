...
@section('page-head-title')
    ...
    @endif
    <a class="navbar-brand nav-bg-blue-primary mx-auto" href="/"><span class="logo-brand">EXCEEDS</span><span
            class="th-3">Mobile</span></a>
@endsection
    ...
    <form action="{{ route('login') }}" method="post">
        ...
        <div class="mt-5" style="max-width: 425px; margin: 0 auto;">
            ...
            <div class="text-center mt-5">
                <img src="{{ asset('img/game-day.svg') }}" alt="Deskripsi Gambar" class="mx-auto"
                    style="max-width: 800px; max-height: 600px; width: 100%; height: auto;">
            </div>
            ...
            <div class="mt-5 container px-1">
                <div class="px-1 py-1">
                    ...
                    <div class="">
                        ...
                        <div class="">
                            <a style="margin-left: 200px;" href="#"
                                class="text-small th-2 text-blue-secondary text-right">Lupa Username/ Password?</a>
                        </div>
                    </div>
                </div>
            </div>
