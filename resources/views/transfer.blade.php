                ...
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                            fill="var(--blue-secondaryHex)" class="bi bi-bank" viewBox="0 0 16 16">
                            <path
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                fill="var(--blue-secondaryHex)" class="bi bi-credit-card" viewBox="0 0 16 16">
                                <path
                                    d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2-1a1 1 0 0 0-1 1v1h14V4a1 1 0 0 0-1-1H2zm13 4H1v5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V7z" />
                                <path d="M2 10a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-1z" />
                            </svg>
                        </span>
                        <input type="text" class="form-control" id="input-norek" name="norek"
                            aria-describedby="basic-addon3 basic-addon4">
                    </div>
                </div>
            </div>
            <div class="footer ">
                <button type="submit" class="buttonPrimary btn-login w-100 th-2 indent-right">Transfer</button>
            </div>
        </form>
    </div>
